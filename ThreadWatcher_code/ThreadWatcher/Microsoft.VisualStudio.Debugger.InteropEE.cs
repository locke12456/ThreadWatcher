...
* 
* All EE Structures and Interfaces that depend on DEBUG_ADDRESS_UNION are also
* included.
* 
...
namespace Microsoft.VisualStudio.Debugger.InteropEE
{
    ...
    public interface IDebugFunctionObject : IDebugObject
    {
        ...
        [PreserveSig]
        int CreateObject(
                [In, MarshalAs(UnmanagedType.Interface)] IDebugFunctionObject pConstructor,
                [In] uint dwArgs,
        ...
        int CreateStringObject(
            [In, MarshalAs(UnmanagedType.LPWStr)] string pcstrString,
            [MarshalAs(UnmanagedType.Interface)] out IDebugObject ppOjbect);
        [PreserveSig]
        int Evaluate(
            [In, Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.Interface, SizeParamIndex = 1)] IDebugObject[] ppParams,
            [In] IntPtr dwParams,
            [In] uint dwTimeout,
