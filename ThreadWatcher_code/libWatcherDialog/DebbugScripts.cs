...
{
    public class DebbugScripts : DebbugScriptsRef
    {
    ...
    public class DebbugScriptsRef : PropertyForm<object, ItemProperties>
    {
        public DebbugScriptsRef()
            : base()
        {
